//
//  AUTransmitterAudioUnit.m
//  AUTransmitter
//
//  Created by Hallgrim Bratberg on 11/08/2021.
//

#import "AUTransmitterAudioUnit.h"
...
@interface AUTransmitterAudioUnit ()
...
@implementation AUTransmitterAudioUnit
...
- (instancetype)initWithComponentDescription:(AudioComponentDescription)componentDescription options:(AudioComponentInstantiationOptions)options error:(NSError **)outError {
	...
	_kernelAdapter = [[AUTransmitterDSPKernelAdapter alloc] init];
...
- (void)setupParameterCallbacks {
	...
	__block AUTransmitterDSPKernelAdapter * kernelAdapter = _kernelAdapter;
